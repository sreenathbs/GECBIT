...
b = [[["CY100"],[4]],[["BE100"],[4]],[["EE100"],[3]],[["CY110"],[1]],[["EE110"],[1]],[["MA102"],[4]],[["BE102"],[3]],[["CS100"],[3]],[["CS120"],[1]]]
b.sort()
...
for i in range(len(f)):
	f[i].sort() #optional, required when result is disordered
...
for i in range(len(g)):
	...
	for j in range(len(courses)):
		xyz += gradepoints[i][j] * credits[j][0]
	points.append(xyz)
...
totalcredits = 0
for j in range(len(courses)):
	totalcredits += credits[j][0]

for i in range(len(points)):
	sgpa.append(round(points[i] / float(totalcredits),2))
